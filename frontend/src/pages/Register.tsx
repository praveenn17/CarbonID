...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden bg-slate-950 items-center justify-center p-4">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-blue-500/20 blur-[100px] rounded-full pointer-events-none" />

      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 mb-6 font-bold shadow-emerald-500/30">
            <Leaf className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Join CarbonID</h1>
          <p className="text-slate-400 mt-2">Start owning your carbon footprint today</p>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-xl text-sm font-semibold text-white bg-emerald-500 hover:bg-emerald-400 focus:outline-none disabled:opacity-50 transition-all duration-200 overflow-hidden mt-2"
            >
